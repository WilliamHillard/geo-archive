...
def transform_literacy_rate():
    input_file = RAW_DATA_DIR / "literacy_rate_raw.json"
    ...
    output = CLEANED_DATA_DIR / "literacy_rate.csv"
    df.to_csv(output, index=False)

    print(f"\nCleaned literacy rate data saved!")
